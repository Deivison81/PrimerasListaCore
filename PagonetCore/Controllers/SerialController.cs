...
namespace PagonetCore.Controllers
{
    public class SerialController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.cod_almacen = new SelectList(itemsAlmacenes, "cod_almacen", "texto", adSerial.cod_almacen);
            ...
            ViewBag.id_art = new SelectList(itemsArticulos, "id_art", "texto", adSerial.id_art);
