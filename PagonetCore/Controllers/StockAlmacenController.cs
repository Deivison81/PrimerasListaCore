...
namespace PagonetCore.Controllers
{
    public class StockAlmacenController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.cod_almacen = new SelectList(itemsAlmacenes, "cod_almacen", "texto", stockAlma.cod_almacen);
            ...
            ViewBag.id_art = new SelectList(itemsArticulos, "id_art", "texto", stockAlma.id_art);
